public class Arena {
    ...
    private void fightRound(Player attacker, Player defender) {
        ...
        System.out.println(attacker.getName() + " (Health: " + attacker.getHealth() + ", Strength: "
                + attacker.getStrength() + ", Attack: " + attacker.getAttack() + ") rolls " + attackRoll +
                ". ");
        System.out.println(defender.getName() + " (Health: " + defender.getHealth() + ", Strength: "
                + defender.getStrength() + ", Attack: " + defender.getAttack() + ") rolls " + defenseRoll +
                ".");
        System.out.println("Attack damage: " + attackDamage + ", Defense strength: " + defenseStrength
                + ", Damage dealt: " + damageDealt + ", Defender's remaining health: " + defender.getHealth());
        System.out.println(
                "----------------------------------------------------------------------------------------------");
    }
